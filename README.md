...
- `_data/photos.yml` - URL фотографій та відео
...
Всі URL фотографій та відео знаходяться в файлі `_data/photos.yml`. Просто відредагуйте цей файл, щоб додати або змінити фотографії.
